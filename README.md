...
- a pasta bin é de onde parte todo o nosso sistema (mesmo princípio de public static void main do Java).
- uma função reaproveitável por exemplo, é um pacote em Dart.
- main é a função principal, de onde parte todo o nosso sistema, ponto de partida.